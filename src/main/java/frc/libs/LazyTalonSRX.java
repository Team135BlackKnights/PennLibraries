...
public class LazyTalonSRX extends WPI_TalonSRX
{
    ...
    public LazyTalonSRX(int deviceID, boolean isBraked)
    {
        super(deviceID);
    ...
    public LazyTalonSRX(int deviceID, boolean isBraked, boolean isInverted)
    {
        super(deviceID);
        brakeMode = isBraked ? NeutralMode.Brake : NeutralMode.Coast;
        upperLimit = 1;
    ...
    public LazyTalonSRX(int deviceID, boolean isBraked, boolean isInverted, double upperLimit, double lowerLimit)
    {
        super(deviceID);
        brakeMode = isBraked ? NeutralMode.Brake : NeutralMode.Coast;
